...
// ================= TELA DE LOGIN CORPORATIVA MONOCROMÁTICA =================
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center relative overflow-hidden bg-[#0B1224] select-none">
      ...
      {/* Brilho volumétrico sutil e corporativo no fundo (sem azuis neon berrantes) */}
      ...
      {/* Container Principal com Animação Holográfica e Float */}
