...
export class EmailsService {
  ...
  /**
   * Dispara e-mail de convite para novos membros da equipe utilizando o SMTP do Tenant.
   */
...
<body>
  ...
  /**
   * Dispara e-mail de redefinição de senha para usuário do tenant utilizando o SMTP do Tenant / Gmail.
   */
