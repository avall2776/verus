...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEmail)({}, { message: 'E-mail corporativo inválido.' }),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => create_plan_dto_1.CreatePlanDto),
    __metadata("design:type", create_plan_dto_1.CreatePlanDto)
], CreateTenantDto.prototype, "customPlan", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
...
__decorate([
    (0, class_validator_1.IsEmail)({}, { message: 'E-mail do administrador inválido.' }),
...
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.MinLength)(6, { message: 'A senha do administrador deve ter pelo menos 6 caracteres.' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'A senha do administrador é obrigatória.' }),
    __metadata("design:type", String)
