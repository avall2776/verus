...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'O assunto do chamado é obrigatório.' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateTicketDto.prototype, "subject", void 0);
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'A descrição detalhada do chamado é obrigatória.' }),
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsIn)(['LOW', 'MEDIUM', 'HIGH', 'URGENT'], { message: 'Prioridade inválida.' }),
    __metadata("design:type", String)
